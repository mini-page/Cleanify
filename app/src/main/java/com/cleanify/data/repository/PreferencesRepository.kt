...
class PreferencesRepository @Inject constructor(
    ...
    private object PreferencesKeys {
        ...
        val HIDE_SWIPER_ACTION_BUTTONS = booleanPreferencesKey("hide_swiper_action_buttons")
        ...
        val SCAN_VIDEO_ENABLED = booleanPreferencesKey("scan_video_enabled")
        val DUPLICATE_SCAN_IMAGES = booleanPreferencesKey("duplicate_scan_images")
        val DUPLICATE_SCAN_VIDEOS = booleanPreferencesKey("duplicate_scan_videos")
        val DUPLICATE_SCAN_AUDIO = booleanPreferencesKey("duplicate_scan_audio")
        val DUPLICATE_SCAN_DOCUMENTS = booleanPreferencesKey("duplicate_scan_documents")
    ...
    private val hideActionButtonsPref = Preference(context.dataStore, PreferencesKeys.HIDE_SWIPER_ACTION_BUTTONS, false)
    ...
    private val scanVideoEnabledPref = Preference(context.dataStore, PreferencesKeys.SCAN_VIDEO_ENABLED, true)
    private val duplicateScanImagesPref = Preference(context.dataStore, PreferencesKeys.DUPLICATE_SCAN_IMAGES, true)
    private val duplicateScanVideosPref = Preference(context.dataStore, PreferencesKeys.DUPLICATE_SCAN_VIDEOS, true)
    private val duplicateScanAudioPref = Preference(context.dataStore, PreferencesKeys.DUPLICATE_SCAN_AUDIO, true)
    private val duplicateScanDocumentsPref = Preference(context.dataStore, PreferencesKeys.DUPLICATE_SCAN_DOCUMENTS, true)
    ...
    val hideActionButtonsFlow: Flow<Boolean> = hideActionButtonsPref.flow
    ...
    val scanVideoEnabledFlow: Flow<Boolean> = scanVideoEnabledPref.flow
    val duplicateScanImagesFlow: Flow<Boolean> = duplicateScanImagesPref.flow
    val duplicateScanVideosFlow: Flow<Boolean> = duplicateScanVideosPref.flow
    val duplicateScanAudioFlow: Flow<Boolean> = duplicateScanAudioPref.flow
    val duplicateScanDocumentsFlow: Flow<Boolean> = duplicateScanDocumentsPref.flow
    ...
    suspend fun setHideActionButtons(enabled: Boolean) = hideActionButtonsPref.set(enabled)
    ...
    suspend fun setScanVideoEnabled(enabled: Boolean) = scanVideoEnabledPref.set(enabled)
    suspend fun setDuplicateScanImages(enabled: Boolean) = duplicateScanImagesPref.set(enabled)
    suspend fun setDuplicateScanVideos(enabled: Boolean) = duplicateScanVideosPref.set(enabled)
    suspend fun setDuplicateScanAudio(enabled: Boolean) = duplicateScanAudioPref.set(enabled)
    suspend fun setDuplicateScanDocuments(enabled: Boolean) = duplicateScanDocumentsPref.set(enabled)
